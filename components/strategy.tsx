...
export function Strategy() {
    return (
        <div className="min-h-screen bg-white flex flex-col justify-center items-center sm:ml-60 max-w-6xl sm:mb-10">
            <h1 className="text-center sm:text-3xl text-xl font-bold text-blue-800 sm:mt-6 mb-8">BUSINESS STRATEGY</h1>

            <div className="overflow-hidden relative sm:right-8 w-full h-full">
                <Image
                ...
                <div className="sm:absolute inset-0 flex flex-col items-start justify-center text-black font-bold sm:text-xl text-sm sm:m-6 m-2 sm:mt-20 space-y-4">
